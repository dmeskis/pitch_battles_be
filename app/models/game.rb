class Game < ApplicationRecord
  ...
  def update_user_scores
    ...
    if self.level_one_duration.present?
    ...
    if self.level_two_duration.present?
    ...
    if self.level_three_duration.present?
    ...
    if self.level_four_duration.present?
    ...
    if self.total_duration.present?
